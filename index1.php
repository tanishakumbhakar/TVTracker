...
<body>
	...
	<form method="post">
		...
		<div class="input-group">
			...
			<a class="sign-up-btn" onclick="location.href='fb.php';" type="submit">Log in with Facebook</a>
		...
		<?php
			...
			if ($gClient->getAccessToken()) 
			{
				...
				$output= '<a href="'.filter_var($authUrl, FILTER_SANITIZE_URL).'">	<div class="btn-div1 btn" width="47%">Log in with Google+</div></a>';
			}
			echo $output;
			?>
